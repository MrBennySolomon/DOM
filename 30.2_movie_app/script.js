...
const fetchMovie = async () => {
  ...
  data.innerHTML = `
  <img src="${info.Poster}">
  <h3>movie title</h3><h5>${info.Title}</h5>
  <h3>year</h3><h5>${info.Year}</h5>
  <h3>Genre</h3><h5>${info.Genre}</h5>
  <h3>plot</h3><h5>${info.Plot}</h5>
  <h3>director</h3><h5>${info.Director}</h5>
  <h3>actors</h3><h5>${info.Actors}</h5>
  <h3>rating</h3><h5>${info.imdbRating} / 10 stars</h5>
  `;
};
